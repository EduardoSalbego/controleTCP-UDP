...
def main():
    ...
    print(f"Servidor UDP escutando em {server_address}")  # Imprime que o servidor está escutando

    while True:
        handle_client(sock, server_address)  # Chama a função para lidar com o cliente
